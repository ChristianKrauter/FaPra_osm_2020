...
printf "\n\nug 360x360\n"
go run osmgw.go -m=2 -x=360 -y=360 -f=planet-coastlines.pbf
printf "\n\nug 360x360 bpip\n"
go run osmgw.go -m=2 -x=360 -y=360 -f=planet-coastlines.pbf -bpip
printf "\n\nug 1000x500"
...
printf "\n\nbg 360x360 bpip"
go run osmgw.go -m=2 -bg -x=360 -y=360 -f=planet-coastlines.pbf -bpip
printf "\n\nbg 1000x500"
